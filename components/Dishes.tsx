...
const AddToCardModal: React.FC<AddToCardModalProps> = ({
	isOpen,
	closeModal,
}) => {
	return (
		<ReactModal
			...
			className={tw`
		      absolute inset-16 mx-auto w-1/2 flex justify-center items-center rounded-lg bg-white bg-opacity-95 outline-none border border-gray-500`}
